...
export const api = {
  ...
  setPluginEnabled: (packageName: string, enabled: boolean) => request<ManagedPlugin>(`/api/plugins/${encodeURIComponent(packageName)}/enabled`, { method: 'PUT', body: JSON.stringify({ enabled }) }),
